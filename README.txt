...
Quando?
  Criado em 07/set/20 por PY7SLB (mlbraga82@gmail.com)
...
Pra quê serve?
  Nas redes DMR é comum, em alguns Talkgroups, que os usuários não deixem um intervalo entre um cambio e outro, impedindo que um operador consiga sair do grupo acionando o TG 4000 (disconnect). Para impedir que o usuário "fique preso" ao TG, é possível usar os comandos da Brandmeister para realizar o DROP QSO e Remove TG para sair de grupos estáticos. Este programa não substitui o TG 4000 (Disconnect) para TG dinâmicos (aqueles que você acessa usando o PTT), porém o programa dará a liberdade para acionar o TG 4000 mesmo que os usuários do TG ocupado estejam ainda transmitindo.
